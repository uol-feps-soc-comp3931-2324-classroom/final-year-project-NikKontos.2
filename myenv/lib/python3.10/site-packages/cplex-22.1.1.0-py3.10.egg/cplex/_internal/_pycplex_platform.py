...
ERROR_STRING = "CPLEX 22.1.1.0 is not compatible with this version of Python."

if platform.system() in ('Darwin', 'Linux', 'AIX', 'Windows', 'Microsoft'):
    if version_info < (3, 7, 0):
        raise Exception(ERROR_STRING)
    elif version_info < (3, 8, 0):
        from cplex._internal.py37_cplex2211 import *
    elif version_info < (3, 9, 0):
        from cplex._internal.py38_cplex2211 import *
    elif version_info < (3, 10, 0):
        from cplex._internal.py39_cplex2211 import *
    elif version_info < (3, 11, 0):
        from cplex._internal.py310_cplex2211 import *
